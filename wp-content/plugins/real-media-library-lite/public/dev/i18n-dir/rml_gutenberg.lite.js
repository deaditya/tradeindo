...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/public/ts/rml_gutenberg.jsx");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/public/ts/rml_gutenberg.jsx":
/*!*****************************************!*\
  !*** ./src/public/ts/rml_gutenberg.jsx ***!
  \*****************************************/
/*! no exports provided */
...
var BLOCK_ID = "real-media-library/gallery",
    registerBlockType = wp__WEBPACK_IMPORTED_MODULE_2__["blocks"].registerBlockType,
    G = wp__WEBPACK_IMPORTED_MODULE_2__["components"].G,
    SVG = wp__WEBPACK_IMPORTED_MODULE_2__["components"].SVG,
    Path = wp__WEBPACK_IMPORTED_MODULE_2__["components"].Path,
    ServerSideRender = wp__WEBPACK_IMPORTED_MODULE_2__["components"].ServerSideRender,
    PanelBody = wp__WEBPACK_IMPORTED_MODULE_2__["components"].PanelBody,
    RangeControl = wp__WEBPACK_IMPORTED_MODULE_2__["components"].RangeControl,
    ToggleControl = wp__WEBPACK_IMPORTED_MODULE_2__["components"].ToggleControl,
    SelectControl = wp__WEBPACK_IMPORTED_MODULE_2__["components"].SelectControl,
    TreeSelect = wp__WEBPACK_IMPORTED_MODULE_2__["components"].TreeSelect,
    Notice = wp__WEBPACK_IMPORTED_MODULE_2__["components"].Notice,
    Spinner = wp__WEBPACK_IMPORTED_MODULE_2__["components"].Spinner,
    Button = wp__WEBPACK_IMPORTED_MODULE_2__["components"].Button,
    withNotices = wp__WEBPACK_IMPORTED_MODULE_2__["components"].withNotices,
    Component = wp__WEBPACK_IMPORTED_MODULE_2__["element"].Component,
    Fragment = wp__WEBPACK_IMPORTED_MODULE_2__["element"].Fragment,
    InspectorControls = wp__WEBPACK_IMPORTED_MODULE_2__["editor"].InspectorControls,
    __ = wp__WEBPACK_IMPORTED_MODULE_2__["i18n"].__;
var linkOptions = [{
  value: "attachment",
...
var SelectFolderControl = /*#__PURE__*/function (_Component) {
  ...
  _createClass(SelectFolderControl, [{
...
var GalleryEdit = /*#__PURE__*/function (_Component2) {
  ...
  function GalleryEdit() {
    ...
    _this2.setLinkTo = function (linkTo) {
      return _this2.props.setAttributes({
        linkTo: linkTo
      });
    };

    _this2.setColumnsNumber = function (columns) {
      return _this2.props.setAttributes({
        columns: columns
      });
    };

    _this2.toggleImageCrop = function () {
      return _this2.props.setAttributes({
        imageCrop: !_this2.props.attributes.imageCrop
      });
    };

    _this2.toggleCaptions = function () {
      return _this2.props.setAttributes({
        captions: !_this2.props.attributes.captions
      });
    };

    _this2.handleReload = function () {
      return _this2.props.setAttributes({
    ...
    _this2.render = function () {
      ...
      var attributes = _this2.props.attributes,
          ...
          columns = _attributes$columns === void 0 ? 3 : _attributes$columns,
...
/******/ });
//# sourceMappingURL=rml_gutenberg.lite.js.map