...
class Service
{
    ...
    {
        register_rest_route(self::LEGACY_NAMESPACE, '/tree', ['methods' => 'GET', 'callback' => [$this, 'routeTree']]);
        register_rest_route(self::LEGACY_NAMESPACE, '/tree/dropdown', ['methods' => 'GET', 'callback' => [$this, 'routeTreeDropdown']]);
        register_rest_route(self::LEGACY_NAMESPACE, '/hierarchy/(?P<id>\\d+)', ['methods' => 'PUT', 'callback' => [$this, 'routeHierarchy']]);
        register_rest_route(self::LEGACY_NAMESPACE, '/usersettings', ['methods' => 'GET', 'callback' => [$this, 'getUserSettingsHTML']]);
        register_rest_route(self::LEGACY_NAMESPACE, '/usersettings', ['methods' => 'PUT', 'callback' => [$this, 'updateUserSettings']]);
    }
    /**
     * See API docs.
     *
    ...
    public function routeTreeDropdown($request)
    {
        ...
        return new \WP_REST_Response(['html' => \MatthiasWeb\RealMediaLibrary\attachment\Structure::getInstance()->getView()->dropdown($request->get_param('selected'), null, \false)]);
    }
    /**
     * See API docs.
     *
    ...
    public function getUserSettingsHTML($request)
    {
        ...
        return new \WP_REST_Response(['html' => \MatthiasWeb\RealMediaLibrary\metadata\Meta::getInstance()->prepare_content('')]);
    }
    /**
     * See API docs.
     *
