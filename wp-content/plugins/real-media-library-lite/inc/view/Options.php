...
class Options {
    ...
    public function html_rml_load_frontend() {
        ...
        echo '<input type="checkbox" id="rml_load_frontend"
            ...
            ' />
                <label>' .
            __('Activate this option if you are using a page builder like Divi Page Builder, WPBakery Page Builder or Elementor.', RML_TD) .
            '</label>';
    }
    ...
    public static function getInstance() {
        return self::$me === null ? (self::$me = new Options()) : self::$me;
    }
}
