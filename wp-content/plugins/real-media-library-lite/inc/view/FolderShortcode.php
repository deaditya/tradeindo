...
class FolderShortcode
{
    ...
    public function shortcode_atts_gallery($out, $pairs, $atts)
    {
        ...
        if ($atts['fid'] > -2) {
            ...
            if ($atts['fid'] > -1) {
                ...
                $out['include'] .= ',' . \implode(',', \MatthiasWeb\RealMediaLibrary\folder\Creatable::xread(-1, $atts['order'], $atts['orderby']));
            }
    ...
    {
        $arr['mce'] = ['mceButtonTooltip' => __('Gallery from Media Folder', RML_TD), 'mceListBoxDirsTooltip' => __('Note: You can only select galleries. Folders and collections are grayed.', RML_TD), 'mceBodyGallery' => __('Folder', RML_TD), 'mceBodyLinkTo' => __('Link to'), 'mceBodyColumns' => __('Columns'), 'mceBodyRandomOrder' => __('Random Order'), 'mceBodySize' => __('Size'), 'mceBodyLinkToValues' => [['value' => 'post', 'text' => __('Attachment File')], ['value' => 'file', 'text' => __('Media File')], ['value' => 'none', 'text' => __('None')]], 'mceBodySizeValues' => [['value' => 'thumbnail', 'text' => __('Thumbnail')], ['value' => 'medium', 'text' => __('Medium')], ['value' => 'large', 'text' => __('Large')], ['value' => 'full', 'text' => __('Full Size')]]];
        return $arr;
    }
    /**
