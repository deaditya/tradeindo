...
You can also order the images into *a custom image order* per drag&drop.',
            ...
            'methodNotAllowed405' => __(
                'An error occurred when requesting the Real Media Library REST endpoint *{endpoint}* from the server (_405 method not allowed_). One reason may be that something is missing from your server configuration.',
                RML_TD
            ),
            'methodNotAllowed405LinkText' => __('Click here to learn how to resolve this', RML_TD),
            'methodMoved301' => __(
                'It seems that the tree could not be fetched because the WP REST API endpoint *tree* is not reachable. Are you using a plugin that disables the WP REST API, like *Clearfy*?',
                RML_TD
            ),
            ...
            'sidebarDetectedTax' => __('It looks like you have already used another plugin for folders in the media library.', RML_TD),
            ...
            'proDismiss' => __('Dismiss 20 days', RML_TD),
            ...
            'proFeatures' => [
                ...
                'limit' => [
                    'title' => 'Want to create more folders?',
                    'image' => 'limit.jpg',
                    'description' => __(
