...
class ExportMediaLibrary
{
    ...
    {
        register_rest_route(\MatthiasWeb\RealMediaLibrary\rest\Service::LEGACY_NAMESPACE, '/massedge/export', ['methods' => 'GET', 'callback' => [$this, 'export'], 'args' => ['type' => ['required' => \true, 'type' => 'string'], 'folder' => ['required' => \true, 'type' => 'integer']]]);
    }
    /**
     * See API docs.
     *
    ...
    public function export($request)
    {
        ...
        switch ($type) {
            // Without subfolders
            case 'wosFlat':
                $options = \array_merge($options, ['folder_structure' => \MassEdge\WordPress\Plugin\ExportMediaLibrary\API::FOLDER_STRUCTURE_FLAT]);
                break;
            case 'wosHierarchical':
                $options = \array_merge($options, ['folder_structure' => \MassEdge\WordPress\Plugin\ExportMediaLibrary\API::FOLDER_STRUCTURE_NESTED]);
                break;
            // With subfolders
            case 'wsFlat':
                $options = \array_merge($options, ['folder_structure' => \MassEdge\WordPress\Plugin\ExportMediaLibrary\API::FOLDER_STRUCTURE_FLAT]);
            ...
            case 'wsHierarchicalRML':
                ...
                $options = \array_merge($options, ['folder_structure' => \MassEdge\WordPress\Plugin\ExportMediaLibrary\API::FOLDER_STRUCTURE_NESTED, 'add_attachment_callback' => function ($file, $attachment) use($resolver, $attachmentIds) {
